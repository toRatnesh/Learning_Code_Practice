...
A data structure is said to be thread-safe
	...
	all invariants will be upheld, and 
	there’ll be no problematic race conditions
...
allow concurrent access from multiple threads that merely read the data structure, 
whereas a thread that can modify the data structure must have exclusive access
