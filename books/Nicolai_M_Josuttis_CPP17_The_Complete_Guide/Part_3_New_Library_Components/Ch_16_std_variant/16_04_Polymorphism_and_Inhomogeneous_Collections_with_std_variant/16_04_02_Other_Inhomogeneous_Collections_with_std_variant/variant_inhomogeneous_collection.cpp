...
16.4.2 Other Inhomogeneous Collections with std::variant
	we can declare inhomogeneous collections with std::variant<>
	define our own type for objects representing one of multiple possible types
	and we can create an initialize an inhomogeneous collection with them
